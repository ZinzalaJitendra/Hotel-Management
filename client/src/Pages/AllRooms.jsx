...
import StarRating from "../components/StarReating";
...
function AllRooms() {
  ...
  const sortOption = ["Price Low to High", "Price High to Law", "Newest First"];
  ...
  return (
    ...
    >
      ...
      <div className="bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16">
        <div
          className={`flex items-center justify-between px-5 py-2.5 min-lg:border border-gray-300 ${
            openFilter && "border-6"
          }`}
        >
